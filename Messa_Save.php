...
if($Action=="Add"){
	...
	if($result){
	 echo "<script language='javascript'> alert('留言成功！');window.location.href='index.php';</script>";
	}else{
	 echo "<script language='javascript'> alert('留言失败！');</script>";
	}
}else{
    echo "<script language='javascript'> alert('非法提交数据！');window.location.href='index.php';</script>";
}
