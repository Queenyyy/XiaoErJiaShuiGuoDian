    ...
    <td valign="top" bgcolor="#FFFFFF"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="95%" height="35" align="left" background="images/titlebg.gif"><strong>新增供货商</strong></td> 
        </tr>
        
      </table>
	  <div class="RightBody">
      <form method="post" id="Form" name="Form" action="Supp_Save.php?Action=Add" onsubmit="return CheckForm();">
      <table class="TableInfo">
        <tr>
		 <td width="80" align="right">供货商编号：</td>
		 <td><input name="SupplierNo" type="text" readonly="readonly" value="SN-<?=rand(1000,9999)?>"/></td>
	    </tr>
		<tr>
		...
		<tr>
		 ...
		 <td><input name="Addr" type="text" />
          &nbsp;<span class="Required">&nbsp;*请填写正确地址</span>
         </td>
	    </tr>
        <tr>
