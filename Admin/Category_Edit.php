    ...
    <td valign="top" bgcolor="#FFFFFF"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="95%" height="35" align="left" background="images/titlebg.gif"><strong>类别信息编辑</strong></td> 
        </tr>
      </table>
      <?php
	  $ID=$_GET['ID'];
	  ...
	  ?>
	  <div class="RightBody">
      <form method="post" id="Form" name="Form" action="Category_Save.php?Action=Edit&ID=<?=$rs['ID']?>" onsubmit="return CheckForm();">
      <table class="TableInfo">
        <tr>
		 <td width="80" align="right">类别编号：</td>
		 <td><input name="CategoryNo" type="text" value="<?=$rs['CategoryNo']?>" readonly="readonly"/></td>
	    </tr>
		<tr>
		 <td width="80" align="right">类别名称：</td>
		 <td><input name="CategoryName" type="text" value="<?=$rs['CategoryName']?>"/>
		 &nbsp;<span class="Required">&nbsp;*必填</span></td>
	    </tr>
        <tr>
		 <td width="80" align="right">描述：</td>
		 <td><textarea name="Description" rows="5"><?=$rs['Description']?></textarea></td>
	    </tr>
		<tr>
