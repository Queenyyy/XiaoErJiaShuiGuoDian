...
function CheckForm(){
	if(document.Form.CategoryNo.value==""){
		alert("类别编号不能为空！");
		return false;
	}
	if(document.Form.CategoryName.value==""){
		alert("类别名称不能为空！");
		return false;
	}
	return true;	
    ...
    <td valign="top" bgcolor="#FFFFFF"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="95%" height="35" align="left" background="images/titlebg.gif"><strong>新增类别</strong></td> 
        </tr>
        
      </table>
	  <div class="RightBody">
      <form method="post" id="Form" name="Form" action="Category_Save.php?Action=Add" onsubmit="return CheckForm();">
      <table class="TableInfo">
        <tr>
		 <td width="80" align="right">类别编号：</td>
		 <td><input name="CategoryNo" type="text" readonly="readonly" value="CN-<?=rand(1000,9999)?>"/>
