    ...
    <td valign="top" bgcolor="#FFFFFF">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ToptitleInfo">
        <tr> 
          ...
          <td width="80%" height="35" align="left" background="images/titlebg.gif"><strong>图片信息</strong></td>
		  <td width="8%" height="35" align="center" valign="middle" background="images/titlebg.gif"><img src="images/syetem_management.png" width="14" height="14" /> <a href="Photo_Add.php">增加</a></td>
      ...
      <table class="TableInfo" onmouseover="changeto()" onmouseout="changeback()" >
		...
		<tr class="ListContent">
         ...
         <td align="center">
		    ...
		    if($rs['IsTop']==0){
		    ?>
            <a href="Photo_Save.php?Action=DisaIsTop&ID=<?=$rs['ID']?>"><font color="#FF0000">置顶</font></a>
            <?php
		    }else{
		    ?>
            <a href="Photo_Save.php?Action=EnaIsTop&ID=<?=$rs['ID']?>"><font color="#0000FF">取消</font></a>
            <?php
		    }
		    ?>
         </td>
		 ...
		 ?>
            ...
            <a href="Photo_Save.php?Action=Disable&ID=<?=$rs['ID']?>">启用</a>
         <?php
		 }else{
		 ?>
         	<img src="images/error.gif" width="16" height="16"/>
            <a href="Photo_Save.php?Action=Enable&ID=<?=$rs['ID']?>">禁用</a>
         <?php
		 }
		 ?> 
         </td>
		 <td class="Operation">
            ...
            <a href="Photo_Edit.php?ID=<?=$rs['ID']?>">编辑</a>&nbsp; &nbsp;
			<img src="images/del.gif"  width="16" height="16" />
            <a href="Photo_Save.php?Action=Del&amp;ID=<?=$rs['ID']?>" onclick="return DelInfo()">删除</a>
		 </td>
	    </tr>
        <?php
		  }
